do local sources, priorities = {}, {};assert(not sources["lunajson.decoder"])sources["lunajson.decoder"]=([===[-- <pack lunajson.decoder> --
local error = error
...
assert(not sources["lunajson._str_lib"])sources["lunajson._str_lib"]=([===[-- <pack lunajson._str_lib> --
local inf = math.huge
local byte, char, sub = string.byte, string.char, string.sub
local setmetatable = setmetatable
